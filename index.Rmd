...
<p>
The following figures summarise the available data for nine inventory sectors. Many more sectors are available in the dataset, as well as memo items that are usually not counted in national totals.
</p>
<p>
Please cite the figures or data as follows: Lamb, W. F. (2025). Tidy GHG Inventories (0.3) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.14637347
</p>
</div>
