...
<p>
The following figures summarise the available data for nine inventory sectors. Many more sectors are available in the dataset, as well as memo items that are usually not counted in national totals. Please cite the figures or data as follows: Lamb, W. F. (2026). Tidy GHG Inventories (v2) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.14512139
</p>
</div>
...
filenames <- list.files("plots/countries/sectors/", pattern="*.svg", full.names=TRUE)

for (file in filenames) {
  
  country <- sub(".*/(.*)\\-sectors.svg", "\\1", file)
  plot <- sub(".*/(.*)\\-sectors.png", "\\1", file)
  
  link_data <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Tidy-GHG-Inventories/main/plots/countries/sectors/", country, "-sectors.xlsx'>data</a>")
  
  link_png <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Tidy-GHG-Inventories/main/plots/countries/sectors/", country, "-sectors.png'>png</a>")
  
  link_pdf <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Tidy-GHG-Inventories/main/plots/countries/sectors/", country, "-sectors.pdf'>pdf</a>")
  
  link_svg <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Tidy-GHG-Inventories/main/plots/countries/sectors/", country, "-sectors.svg'>svg</a>")
  
  # --- Read and embed SVG inline ---
  ...
  #cat("<div class='svg-container'>")
  #cat(svg_content)
  #cat("</div>")
  #cat(paste0("<div class='figure-text'>", country, " | ", link_data, " | ", link_png, " | ", link_pdf, " | ", link_svg, "</div>"))
  #cat("</div>")
  ...
  div(
    ...
    div(
      class = "figure-text",
      HTML(paste(country, "|", link_data, "|", link_png, "|", link_pdf, "|", link_svg))
    )
  )
