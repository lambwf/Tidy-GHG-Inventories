...
<p>
The following figures summarise the available data for nine inventory sectors. Many more sectors are available in the dataset, as well as memo items that are usually not counted in national totals. Please cite the figures or data as follows: Lamb, W. F. (2025). Tidy GHG Inventories (1.3) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.14512139
</p>
</div>
...
for (file in filenames) {
  ...
  link_svg <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Tidy-GHG-Inventories/main/plots/countries/", country, ".svg'>svg</a>")
