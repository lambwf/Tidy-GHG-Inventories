...
### compile_crt_energy
- extract detailed GHG emissions data in the energy sector from individual CRT files, check for consistency with the summary sheets and save into a structured, consistent format
